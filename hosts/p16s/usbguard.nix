...

{
  services.usbguard = {
    ...
    rules = ''
      ...
      # Boox Tab Mini C (mass storage when off, MTP when on)
      allow id 05c6:f000 serial "8740249" name "LAGOON-MTP _SN:6C04A29D" hash "iG5mDt2YilFoaqIs6q75VFBvNrMGpkuhzpaEPG1S/x0=" parent-hash "itWJ0jdmwMTs9EuQmilJnh3Dqny0qDjLh6uoalee/iA=" via-port "1-2" with-interface 08:06:50 with-connect-type "hotplug"
      allow id 18d1:4ee1 serial "8740249" name "LAGOON-MTP _SN:6C04A29D" hash "6kjeRWhq+dJ3YHwevjU9UeoT+MwduLiHnpiOwbWysY0=" parent-hash "itWJ0jdmwMTs9EuQmilJnh3Dqny0qDjLh6uoalee/iA=" via-port "1-2" with-interface ff:ff:00 with-connect-type "hotplug"
      ...
      # Nitrokey 3 (primary)
      allow id 20a0:42b2 serial "" name "Nitrokey 3" hash "+Zcm46wQ/UwUr3nX98/2IGKa+waAT5osWnQDFteV6RY=" with-interface { 0b:00:00 03:00:00 } with-connect-type "hotplug"
      # Nitrokey 3 (backup)
      allow id 20a0:42b2 serial "" name "Nitrokey 3" hash "T9Zt4v5zG9L3/pJKyEh10TpcF7ANpJSr1Kb5gcIz9Gg=" with-interface { 0b:00:00 03:00:00 02:02:00 0a:00:00 } with-connect-type "hotplug"
    '';
  };
}
